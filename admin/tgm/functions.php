 ...
 */
require_once NORA_ADMIN . '/tgm/class-tgm-plugin-activation.php';
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     	=> 'dominothemes Portfolio', 
			'slug'     	=> 'dominothemes-portfolio', 
			'source'   	=> 'http://themesymbol.com/dominothemes-portfolio.zip', 
			'required' 	=> true, 
		),
	...
	$config = array(
		...
		'strings'      => array(
			...
			'contact_admin'                   => esc_html__( 'Please contact the administrator of this site for help.', 'nora' ),
